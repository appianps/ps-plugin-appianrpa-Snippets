...
#### 2. [3270 Snippet](https://github.com/appianps/ps-plugin-appianrpa-Snippets/tree/master/snippets-low-code/snippet-ibm-3270-ehllapi-library).

The Snippet IBM3270 Manager covers some methods to ease the IBM3270 terminal management. Use the low code workflow library (ehllapi) and NOT the java snippet / example.
