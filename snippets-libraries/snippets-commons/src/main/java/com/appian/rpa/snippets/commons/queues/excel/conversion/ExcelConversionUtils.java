package com.appian.rpa.snippets.commons.queues.excel.conversion;
...
public class ExcelConversionUtils {
	...
	public static <T> T map2Object(Map<String, String> map, Class<T> clazz) throws JidokaException {
		...
		try {
			...
			List<Field> fields = AnnotationUtils.getFieldsWithAnnotation(clazz, AExcelField.class);
	...
	public static Map<String, String> object2Map(Object object) throws JidokaException {
		...
		try {
			...
			List<Field> fields = AnnotationUtils.getFieldsWithAnnotation(object.getClass(), AExcelField.class);
